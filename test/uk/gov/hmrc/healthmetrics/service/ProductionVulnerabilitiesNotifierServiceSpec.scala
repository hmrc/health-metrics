...
import uk.gov.hmrc.healthmetrics.model.{SlugInfoFlag, TeamName}
...
class ProductionVulnerabilitiesNotifierServiceSpec
  ...
  case class Setup():
    ...
    val service = new ProductionVulnerabilitiesNotifierService(vulnerabilitiesConnector, slackNotificationsConnector)
